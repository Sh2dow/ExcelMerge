    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Cultures =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ja-JP"] = new Dictionary<string, string>
            {
                ...
                ["CopyCsv"] = "CSV をコピー",
                ["Ready"] = "準備完了",
                ["NoSession"] = "ファイルを選択して比較を実行してください。",
                ["Language"] = "言語",
                ["Theme"] = "テーマ",
                ["Light"] = "ライト",
                ["Dark"] = "ダーク",
                ...
                ["Comparison"] = "比較",
                ["KeyColumns"] = "キー列",
                ["FormulaCachedValues"] = "数式のキャッシュ値を比較",
                ["CompareDisplayText"] = "表示テキストを比較",
                ["CompareStyles"] = "セルスタイルを比較",
                ["CompareRowMetadata"] = "行メタデータを比較",
                ["BlankAsMissing"] = "明示的な空白を未設定として扱う",
                ["Save"] = "保存",
                ["SettingsSaved"] = "設定を保存しました",
                ["InvalidKeyColumns"] = "キー列を列名または正の数で入力してください。",
                ["ComparisonGrid"] = "同期比較グリッド",
                ["LegacyWorkbookUnsupported"] = "従来の .xls 形式には対応していません。先に .xlsx に変換してください。",
            },
